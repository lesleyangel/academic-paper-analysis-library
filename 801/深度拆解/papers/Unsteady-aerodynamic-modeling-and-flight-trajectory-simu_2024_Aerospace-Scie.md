...
> 自动分析说明：以下基于 `jmps/文本/txt/Unsteady-aerodynamic-modeling-and-flight-trajectory-simu_2024_Aerospace-Scie.txt` 的章节标题抽取与标题关键词判断生成；PDF 抽取可能漏掉跨行小标题，最终章节名仍建议结合原 PDF 目录和版面核查。
